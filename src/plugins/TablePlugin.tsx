...
import type {
  ...
  TableSelection,
} from '../nodes/lexical-table/src/index';
...
import {$insertFirst } from '../nodes/lexical-table/src/LexicalTableUtils'
import {
  $getNodeByKey,
  $isTextNode,
  $nodesOfType,
...
export function TablePlugin({
  ...
  useEffect(() => {
    ...
    console.log('hasCellBackgroundColor', hasCellBackgroundColor)
    return editor.registerNodeTransform(TableCellNode, (node) => {
