...
export class TableCellNode extends DEPRECATED_GridCellNode {
  ...
  getBorder(): null | string {
    return this.getLatest().__border;
  }

  setBackgroundColor(newBorder: null | string): void {
    this.getWritable().__backgroundColor = newBorder;
  }

  setBorder(newBorder: null | string): void {
